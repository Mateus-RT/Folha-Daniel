...
@Entity
@Table(name = "faixa_irrf")
public class FaixaIrrfJpaEntity {
    ...
    @Column(name = "parcela_deduzir", nullable = false, precision = 15, scale = 2)
    private BigDecimal parcelaDeduzir;

    // Construtor padrão
    public FaixaIrrfJpaEntity() {}
    ...
    public void setParcelaDeduzir(BigDecimal parcelaDeduzir) { this.parcelaDeduzir = parcelaDeduzir; }
}
